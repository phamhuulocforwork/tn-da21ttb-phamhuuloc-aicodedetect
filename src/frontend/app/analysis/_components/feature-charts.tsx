...
// Box plot placeholder (would need Chart.js implementation)
...
export function FeatureCharts({ featureGroups, className }: FeatureChartsProps) {
      ...
      <Card className={className}>
        <CardContent className="flex items-center justify-center py-12">
          <div className="text-center">
            ...
            <h3 className="font-semibold mb-2">No Data to Visualize</h3>
            <p className="text-sm text-muted-foreground">
              Complete an analysis to see feature visualizations.
            </p>
          </div>
        </CardContent>
      </Card>
  ...
  return (
    <div className={`space-y-6 ${className}`}>
      <div className="flex items-center justify-between">
        <div>
          <h3 className="text-lg font-semibold">Feature Visualizations</h3>
          <p className="text-sm text-muted-foreground">
            Interactive charts showing analysis results across different feature groups
          </p>
        </div>
